...
void *alice_thread_fn(void *arg) {
    ...
    for (size_t i = 0; i < args->n_deposits; i++) {
        ...
        account_print_info(args->account);
    }
...
int main(int argc, char **argv) {
    ...
    pthread_create(&tid[2], NULL, (void *) account_print_info, (void *)&account);
    pthread_create(&tid[3], NULL, (void *) account_print_info, (void *)&account);
    pthread_create(&tid[4], NULL, (void *) account_print_info, (void *)&account);
    pthread_create(&tid[5], NULL, (void *) account_print_info, (void *)&account);
